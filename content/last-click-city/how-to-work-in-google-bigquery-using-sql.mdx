...
- [Queries](#queries)
  - [What is going on in the table?](#what-is-going-on-in-the-table)
- [SELECT](#select)
  - [Basics](#basics)
  - [Querying two tables](#querying-two-tables)
- [FROM](#from)
- [WHERE](#where)
  - [Simple Conditions](#simple-conditions)
  - [More complex conditions](#more-complex-conditions)
- [AND / OR](#and-or)
  - [More and more conditions](#more-and-more-conditions)
- [GROUP BY](#group-by)
  - [Data types in the column: STRING / INTEGER / BOOLEAN / TIMESTAMP](#data-types-in-the-column-string-integer-boolean-timestamp)
...
- [SUBQUERIES, WITH, PARSING, SUBSTRING, MERGING TWO COLUMNS IN ONE](#subqueries-with-parsing-substring-merging-two-columns-in-one)
  - [SUBSTR](#substr)
  - [Column Parsing](#column-parsing)
  - [Merge columns](#merge-columns)
  - [Make SQL do the calculations instead of you – analytical functions](#make-sql-do-the-calculations-instead-of-you-analytical-functions)
...
<h2 id="what-is-google-bigquery">What is Google Bigquery?</h2>
...
<p id="terminology"><strong>Terminology</strong></p>
...
<p id="what-is-going-on-in-the-table"><strong>What is going on in the table?</strong></p>
...
<p id="basics"><strong>Basics</strong></p>
...
<p id="querying-two-tables"><strong>Querying two tables</strong></p>
...
<p id="simple-conditions"><strong>Simple Conditions</strong></p>
...
<p id="more-complex-conditions"><strong>More complex conditions</strong></p>
...
<p id="more-and-more-conditions"><strong>More and more conditions</strong></p>
...
<p id="data-types-in-the-column-string-integer-boolean-timestamp"><strong>Data types in the column: STRING / INTEGER / BOOLEAN / TIMESTAMP</strong></p>
...
<h2 id="timestamp-and-date">TIMESTAMP AND DATE</h2>
...
We want to touch upon the issue where you want to have a date column. Here, it is preferable to either use TIMESTAMP with hours, minutes, seconds and even milliseconds or the INTEGER type, which stores the UNIX (UNIX Epoch) date. For example, for the date January 1, 2018, this could be <strong>1514764801</strong>. What does this number mean? It is the number of seconds that have elapsed since January 1, 1970. If you see this kind of number but with three more digits (e.g., 1514764801

<em>000</em>), it is the same but in milliseconds!
...
A helpful resource for testing conversion from seconds to the date (and vice versa) can be found at [epochconverter.com](https://www.epochconverter.com/).

January 1, 2018 in seconds:

![BigQuery project](/images/last-click-city/BigQuery_guide/january-1-seconds.png)

January 1, 2018 in milliseconds:

![BigQuery project](/images/last-click-city/BigQuery_guide/january-1-milliseconds.png)

<h2 id="vlookup-2-0-or-joined-tables-left-join-each-right-join-each">VLOOKUP 2.0 or joined tables: LEFT-JOIN EACH / RIGHT-JOIN EACH</h2>
...
<h2 id="case-when-then-end">CASE WHEN... THEN... END</h2>
...
![BigQuery project](/images/last-click-city/BigQuery_guide/case-results.png)
...
![BigQuery project](/images/last-click-city/BigQuery_guide/case-results-2.png)
...
![BigQuery project](/images/last-click-city/BigQuery_guide/case-results-3.png)

<h2 id="subqueries-with-parsing-substring-merging-two-columns-in-one">SUBQUERIES, WITH, PARSING, SUBSTRING, MERGING TWO COLUMNS IN ONE</h2>
...
![BigQuery project](/images/last-click-city/BigQuery_guide/shakespeare.png)
...
![BigQuery project](/images/last-click-city/BigQuery_guide/word-results.png)
...
![BigQuery project](/images/last-click-city/BigQuery_guide/word-results-2.png)
...
![BigQuery project](/images/last-click-city/BigQuery_guide/word-results-3.png)
...
![BigQuery project](/images/last-click-city/BigQuery_guide/substr.png)

![BigQuery project](/images/last-click-city/BigQuery_guide/substr-result.png)

You will want to use it as a marketer if, for example, you want to get a specific part of a URL from website streaming.

<h2 id="column-parsing">Column Parsing</h2>
...
![BigQuery project](/images/last-click-city/BigQuery_guide/column-parsing-results.png)
...
![BigQuery project](/images/last-click-city/BigQuery_guide/column-parsing-results-2.png)
...
![BigQuery project](/images/last-click-city/BigQuery_guide/column-parsing-results-3.png)
...
<h2 id="merge-columns">Merge columns</h2>
...
![BigQuery project](/images/last-click-city/BigQuery_guide/before.png)

![BigQuery project](/images/last-click-city/BigQuery_guide/after.png)

<h2 id="make-sql-do-the-calculations-instead-of-you-analytical-functions">Make SQL do the calculations instead of you – analytical functions</h2>
...
![BigQuery project](/images/last-click-city/BigQuery_guide/analytical-functions-results.png)
