...
This becomes especially visible in three brand-architecture patterns: a **branded house** (Apple), where every product ladders up to one master brand; a **house of brands** (Procter & Gamble), where each brand stands on its own by design; and a **fragmented portfolio** (Yahoo), where products accumulate without a coherent architecture. In a house of brands, the fragmentation is intentional and strategically aligned. In a fragmented portfolio, it is not — the company tries to present itself as a unified ecosystem while internally operating as disconnected teams.
...
| Yahoo — fragmented portfolio | Procter & Gamble — house of brands | Apple — branded house |
| ---------------------------- | ---------------------------------- | --------------------- |
